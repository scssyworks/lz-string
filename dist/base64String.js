  ...
  var Base64String = {
    ...
    compress: function compress(input) {
      ...
      if (flush) {
        ...
        output = (_readOnlyError("output"), output.join(''));
        output = (_readOnlyError("output"), String.fromCharCode(output.charCodeAt(0) | 256) + output.substring(1));
      } else {
        output = (_readOnlyError("output"), output.join(''));
      }
